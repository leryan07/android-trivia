...
abstract class TriviaSettingsDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile
        private var INSTANCE: TriviaSettingsDatabase? = null

        fun getInstance(context: Context): TriviaSettingsDatabase {
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                            ...
                            TriviaSettingsDatabase::class.java,
                            "trivia_settings_database"
                    )
